...
public class UserRestControllerDocumentation {
    ...
    @Test
    public void ownsUserDetailsWhenNotLoggedInExample() throws Exception {
        ...
        mockMvc.perform(post("/api/users")
                ...
                .andDo(document("create-user", 
                        ...
                        responseFields(
                            ...
                            fieldWithPath("mobileToken").description("The unique mobile token of the device (for push notification).")
                        )));
    }
}
