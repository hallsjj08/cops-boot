...
public class UserRestControllerTest {
    ...
    @Test
    void givenAuthenticatedUser_userEndpointReturnsOk() throws Exception {
    ...
    void givenAuthenticatedOfficer_userIsCreated() throws Exception {
        ...
        when(userService.createUser(any(CreateUserParameters.class)))
                .thenReturn(new User(userId,
                        new Email("wim@example.com"),
                        new AuthServerId(UUID.fromString("eaa8b8a5-a264-48be-98de-d8b4ae2750ac")),
                        new MobileToken("c41536a5a8b9d3f14a7e5472a5322b5e1f76a6e7a9255c2c2e7e0d3a2c5b9d0")));
        mockMvc.perform(post("/api/users")
                        .with(jwt().jwt(builder -> builder.subject(UUID.randomUUID().toString()).claim("email", "win@example.com"))
                ...
                .andExpect(jsonPath("mobileToken").value("c41536a5a8b9d3f14a7e5472a5322b5e1f76a6e7a9255c2c2e7e0d3a2c5b9d0"))
                .andReturn();
    }
